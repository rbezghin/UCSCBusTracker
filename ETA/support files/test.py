...
for o in outer_stops:
  ...
  json_obj = json.loads(post_resp.text)
  json_final = json.dumps(json_obj, indent=2)
  print(json_final)
  print("\n")
...
'''
format: {"rows":[{"bus_id":"72","bus_type":"LOOP","Main_Entrance_ETA":"10"},{"bus_id":"74","bus_type":"LOOP","Main_Entrance_ETA":"10"},{"bus_id":"78","bus_type":"LOOP OUT OF SERVICE AT THE BARN THEATER","Main_Entrance_ETA":"10"},
    {"bus_id":"81","bus_type":"UPPER CAMPUS","Main_Entrance_ETA":"10"}]}
'''
